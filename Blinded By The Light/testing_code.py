...
while True:
	...
	screen.blit(player, (200, 100), (25*player_scale, 0*player_scale, 8*player_scale, 16*player_scale))
	screen.blit(player, (200, 200), (0*player_scale, 0*player_scale, 8*player_scale, 16*player_scale))
